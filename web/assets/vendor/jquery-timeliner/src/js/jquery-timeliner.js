...
;(function ( $, window, document, undefined ) {
    ...
    Timeliner.prototype = {
         ...
         */
        init: function() {
            this.add(this.$el.find(this.config.itemSelector)[0]).render();
